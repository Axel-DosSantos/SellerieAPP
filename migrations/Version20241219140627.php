 ...
 */
final class Version20241219140627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE history (id INT AUTO_INCREMENT NOT NULL, equipment_id INT NOT NULL, movement_id INT NOT NULL, user_id INT NOT NULL, event_date DATE NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_27BA704B517FE9FE (equipment_id), INDEX IDX_27BA704B229E70A7 (movement_id), INDEX IDX_27BA704BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
